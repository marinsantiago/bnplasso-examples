# ------------------------------------------------------------------------------
# Simulation setting with n = 100, rho = 0.7 and sigma2 = 5, on BB-SSL
# ------------------------------------------------------------------------------
...
export.results.bbssl(n, rho, sigma2 = sigma2, reps, run)

# Load the results -------------------------------------------------------------

path <- paste0(subfolder.path(n, rho, sigma2 = sigma2, reps, bbssl = T), "/")
paste0(path, current.set(n, rho, sigma2 = sigma2, reps), "_run", run, ".Rdata") |> load()

# Print the results ------------------------------------------------------------

# BB-SSL n = 100. rho = 0.3, sigma2 = 5, run = 1/1.
