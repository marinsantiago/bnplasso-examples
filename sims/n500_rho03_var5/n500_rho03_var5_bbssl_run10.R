# ------------------------------------------------------------------------------
# Simulation setting with n = 500, rho = 0.3 and sigma2 = 5, BB-SSL (RUN 10/10)
# ------------------------------------------------------------------------------
...
path <- paste0(subfolder.path(n, rho, sigma2 = sigma2, reps, bbssl = T), "/")
paste0(path, current.set(n, rho, sigma2 = sigma2, reps), "_run", 1, ".Rdata") |> load()

# Print the results ------------------------------------------------------------

# BB-SSL n = 500, rho = 0.3, sigma2 = 5, run = 10/10, reps = 200
